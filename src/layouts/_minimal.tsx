        ...
        >
            <div className="mx-auto flex w-full max-w-[1120px] items-center justify-between">
                ...
                <div className="flex items-center">
                    ...
                    <div className="hidden lg:block xl:hidden ml-4">
                        <Hamburger
                            isOpen={isOpen}
                            onClick={() => openDrawer('DRAWER_MENU')}
                            color="white"
...
export default function MinimalLayout({
    ...
    return (
        <>
            <Header/>
            <div
                className="bg-light-100 dark:bg-dark-100 mt-8 flex min-h-screen flex-col gap-6 px-4 sm:px-6 lg:px-8 3xl:px-10">
